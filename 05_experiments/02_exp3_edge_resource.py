# experiments/exp3_edge_resource.py

"""
实验3：边缘服务器资源倍数 对 边缘收益 的影响
"""
...
def run_experiment_3():
    ...
    print("=============================================")
    print(" 实验3：边缘资源扩容 对 边缘收益 的影响")
    print("=============================================\n")

    for factor in x_vals:
        user = generate_user(user_id=0, num_tasks=20)
        edge, cloud = build_edge_cloud(edge_factor=factor)
